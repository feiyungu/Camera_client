package com.example.ye_song.camera_client;
...
public class GetIP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TableLayout loginForm = (TableLayout)getLayoutInflater().inflate( R.layout.activity_get_ip, null);
        ...
        builder.setPositiveButton("登录"
                ...
                ,new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(GetIP.this,Camera_capture.class);
